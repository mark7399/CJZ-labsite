...
<section class="hero">
  <div class="hero__content">
    ...
    <div class="hero__actions">
      <a class="btn btn--primary" href="research/">了解科研方向</a>
      <a class="btn" href="contact/">加入 / 合作洽谈</a>
    </div>
  </div>
...
<section class="focus-grid">
  <article class="focus-card">
    ...
    <a href="projects/">数据平台与工具 →</a>
  </article>
  <article class="focus-card">
    <h2>脑科学</h2>
    <p>面向脑疾病、脑-机接口等场景，从非编码 RNA 到神经环路，揭示分子与功能联系。</p>
    <a href="research/">研究计划 →</a>
  </article>
  <article class="focus-card">
    <h2>机器学习</h2>
...
<!-- 加入我们区块已按要求移除，统一使用顶部按钮导航到 Opportunities -->